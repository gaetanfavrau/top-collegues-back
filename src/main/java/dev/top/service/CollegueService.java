...
public class CollegueService {
	...
	public Collegue findCollegueByMatriculeFromWebApi (String matricule) throws ServiceException, MatriculeInvalideException {

		RestTemplate restTemplate = new RestTemplate();
		CollegueSource[] list = restTemplate.getForObject("http://collegues-api.cleverapps.io/collegues?matricule=" + matricule, CollegueSource[].class);
